    ...
    <Fragment>
      <div className='flex items-center justify-between mb-[31px] relative z-[2] pr-4 gap-2'>
        ...
        <div className="flex items-center gap-3">
          <div className="rounded-full w-9 h-9 md:w-12 md:h-12 select-none bg-primary flex items-center justify-center hover:bg-primary/80 hover:scale-110 transition-all duration-300" onClick={prev}>
            <ArrowLongLeftIcon className="w-7 h-7 md:h-6 md:w-6 text-white" />
          </div>
          <div className="rounded-full w-9 h-9 md:w-12 md:h-12 select-none bg-primary flex items-center justify-center hover:bg-primary/80 hover:scale-110 transition-all duration-300" onClick={next}>
