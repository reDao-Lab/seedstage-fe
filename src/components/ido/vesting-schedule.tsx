        ...
        <table className="table-auto xl:w-full space-y-1 border-separate border-spacing-y-1 w-[1024px] overflow-x-scroll">
          <thead className=''>
            <tr className='text-[#5B5B5B] text-left bg-[#0A0A0A]'>
              <th className='font-medium py-3 pl-3 rounded-tl-md rounded-bl-md'>#</th>
              ...
              <th className='font-medium py-3 pr-3 text-right rounded-tr-md rounded-br-md'>Claim Type</th>
            </tr>
          </thead>
          <tbody className='space-y-1'>
            <tr className='bg-[#0A0A0A] text-[#E7E7E7] text-left'>
              <td className='font-medium py-3 pl-3 rounded-tl-md rounded-bl-md'>1</td>
              ...
              <td className='font-medium py-3 pr-3 text-right rounded-tr-md rounded-br-md'>On reDAO launchpad</td>
            </tr>
          </tbody>
        </table>
